...
<body id="category">
					...
					<div class="collapse navbar-collapse offset" id="navbarSupportedContent">
						<ul class="nav navbar-nav menu_nav ml-auto">
							...
							<li class="nav-item submenu dropdown active">
								...
								<ul class="dropdown-menu">
									<li class="nav-item active"><a class="nav-link" href="category.html">Boots</a></li>
									<li class="nav-item"><a class="nav-link" href="category.html">Sandal</a></li>
						...
						<ul class="nav navbar-nav navbar-right">
							...
							<li><a class="nav-link" href="#" id="cart"><i class="ti-bag"></i><span class="badge"><p>3</p></span></a></li>
	...
	<!-- back to top button-->
	<button id="myBtn" title="Lên đầu trang"><img src="assets/img/buttonTop.png" title='lên đầu trang' width='40px' height="40px"/></button>
			...
			<div class="breadcrumb-banner d-flex flex-wrap align-items-center justify-content-end">
				<div class="col-first">
					...
					<nav class="d-flex align-items-center">
						...
						<a href="category.html">Nam<span class="lnr lnr-arrow-right"></span></a>
				...
				<div class="sidebar-categories">
					...
					<ul class="main-categories">
						...
						<li class="main-nav-list"><a data-toggle="collapse" href="#beverages" aria-expanded="false" aria-controls="beverages"><span
								 class="lnr lnr-arrow-right"></span>Giày chạy bộ<span class="number">(24)</span></a>
						...
						<li class="main-nav-list"><a data-toggle="collapse" href="#homeClean" aria-expanded="false" aria-controls="homeClean"><span
								 class="lnr lnr-arrow-right"></span>Giày đá banh<span class="number">(53)</span></a>
				...
				<div class="filter-bar d-flex flex-wrap align-items-center">
					...
					<div class="sorting mr-auto">
						<select>
							...
							<option value="1">Size 41</option>
							<option value="1">Size 42</option>
						</select>
					</div>
	...
	<footer class="footer-area section_gap">
		<div class="container">
			...
			<div class="footer-bottom d-flex justify-content-center align-items-center flex-wrap">
				<p class="footer-text text-gray m-0"><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
