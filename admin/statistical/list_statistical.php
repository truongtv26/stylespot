        ...
        <div class="card" id="date">
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table class="table text-center table-bordered table1">
                    <?php
                    foreach ($product_best_seller as $month => $bill):
                        ?>
                        <tbody>
                        <tr>
                            <td colspan="2" class="fs-4 font-weight-bold">Tháng <?=$month?></td>
                        </tr>
                        <tr>
                            <td class="fs-6 font-weight-bold">Sản phẩm</td>
                            <td class="fs-6 font-weight-bold">Số lượng đặt hàng</td>
                        </tr>
                        <?php
